...
@Setter
@AllArgsConstructor
public class GetPostRes implements Comparable<GetPostRes>{
    ...
    public GetPostRes(boolean isFlag, Long flagIdx, Long pictureIdx, String imgUrl, int userIdx, String level, String userName, String createdAt, String fileUrl) {
        this.isFlag = isFlag;
    ...
    @Override
    public int compareTo(@NotNull GetPostRes o) {
